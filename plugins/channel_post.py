...
@Client.on_message(filters.private & ~filters.command(['start','users','broadcast','batch','genlink','usage', 'pbroadcast', 'ban', 'unban']))
async def channel_post(client: Client, message: Message):
    ...
    link = f"https://krpicture0.blogspot.com?start={base64_string}"
